...
<!-- Naslov stranice i dugmad za prelazak na iste -->
  ...
  <a href="first_page.php"><button type="button" class="btn btn-primary" >Početna strana</button></a>
    ...
    <a href="settings.php"><button type="button" class="btn btn-primary" >Podešavanje naloga</button></a>
    <a href="customer.php?action=logout"><img src="pictures\logout.png" class="customer_logout" /></a>
  </div>
  <!-- Forma za unos firme -->
